...
ALLEGRO_SAMPLE* PACMAN_MOVESOUND2 = NULL;
...
void shared_init(void) {
	...
	themeMusic2 = load_audio("Assets/Music/theme2.mp3");
	themeMusic3 = load_audio("Assets/Music/yoasobi.mp3");
	PACMAN_MOVESOUND = load_audio("Assets/Music/pacman-chomp.ogg");
	PACMAN_MOVESOUND2 = load_audio("Assets/Music/pacman_eatfruit3.mp3");
...
void shared_destroy(void) {
	...
	al_destroy_sample(PACMAN_MOVESOUND2);
